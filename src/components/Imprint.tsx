...
const Imprint: React.FC = () => (
  <div className="text-sm px-3 pb-8 font-ubuntu-mono md:px-8">
    <div className="flex flex-col">
      ...
      <a href="mailto:KayHennig98@gmail.com" className="text-sky-400">
        KayHennig98@gmail.com
      </a>
      <a href="tel:+4917643666014" className="text-sky-400">
        +49 176 43666014
      </a>
    </div>
    <div className="flex flex-col">
      <span className="font-bold pt-5 pb-1 uppercase text-lg text-green-600">
        // English
      </span>
    </div>
    <div className="flex flex-col">
      ...
      <span>
        The content of my website has been compiled with meticulous care and to the best of my knowledge.
        However, I cannot assume any liability for the up-to-dateness, completeness or accuracy of any of the pages.
        Pursuant to section 7, para. 1 of the TMG (Telemediengesetz - Tele Media Act by German law),
        I as service providers are liable for my own content on these pages in accordance with general laws.
        However, pursuant to sections 8 to 10 of the TMG,
        I as service providers are not under obligation to monitor external information provided or stored on our website.
        Once I have become aware of a specific infringement of the law, I will immediately remove the content in question.
    ...
    <div className="flex flex-col">
      ...
      <span>
        ...
        Any duplication, processing,
        distribution or any form of utilisation beyond the scope of copyright law shall require the prior written consent of the author or authors in question.
      </span>
    </div>
    <div className="flex flex-col">
      <span className="font-bold pt-5 pb-1 uppercase">
      ...
      <br />
      <span>
        *This disclaimer is based on a <a href="https://www.mustervorlage.net/disclaimer-muster" className="text-sky-400">template by mustervorlage.de</a>
      </span>
    </div>
    <div className="flex flex-col">
      <span className="font-bold pt-5 pb-1 uppercase text-lg text-green-600">
    ...
    <div className="flex flex-col">
      ...
      <span>
        ...
        Dennoch übernimmt der Anbieter dieser Webseite keine Gewähr für die Aktualität,
    ...
    <div className="flex flex-col">
      ...
      <span>
        Die Webseite enthält sog. „externe Links“ (Verlinkungen) zu anderen Webseiten, auf deren Inhalt der Anbieter der Webseite keinen Einfluss hat.
    ...
    <div className="flex flex-col">
      ...
      <br />
      <span>
        * für die Erstellung dieser Seite wurde eine <a href="https://www.mustervorlage.net/disclaimer-muster" className="text-sky-400">Vorlage von mustervorlage.de</a> genutzt.
      </span>
    </div>
  </div>
);
